...
**********************************************************************************************/
%let projectId = 30ea775e-7e48-4b33-a9a8-b4fa76732cab;
%let modelId = 918a5b8e-884a-43d3-b9c6-69f332b95803;
%let datasourceUri = %NRSTR(/dataTables/dataSources/cas~fs~cas-shared-default~fs~CASUSER(JoseIvanAlejandro.Cordero@sas.com)/tables/TRAIN_MARKETING_TARGETS);
